...
const Hero = () => {
  return (
    <section className="w-full h-[100vh] py-4 gid content-center bg-mobile-hero md:bg-hero-image bg-cover bg-center bg-origin-content">
        <div className="w-full mx-auto grid content-center mt-4 h-full">
            <div className="flex flex-col items-start gap-3 z-20 mx-auto">
